     ...
     exit;
      ...
      $username = $_SESSION['username'];
       $viewongooglemap="default" ;
   	   $query1="INSERT INTO roominfo(datetime,username,landlord,address,image1,image2,image3,rent,info,levelset,status,cat1)
   	    VALUES('$datetime','$username','$landlord','$address','$image1','$image2','$image3','$rent','$info','$levelset','on','$Cat1')";
