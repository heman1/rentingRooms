		...
		?>
          ...
          <div class="col-lg-6 col-md-4 col-sm-12">
		    ...
		    <div class="col-lg-6 col-md-8 col-sm-12">
		    	    <blockquote>
		           <h4><cite title="Source Title">Published By:<a href="userprofile.php?name=<?php echo $username; ?>"><?php echo $datarows['username']; ?></a></cite></h4>
		           ...
		           <h4><cite title="Source Title">Owner:<?php echo $datarows['landlord']; ?></cite></h4>
		            ...
		            <blockquote>
		                <h4><cite title="Source Title">Category :</h4>
		            </blockquote>
		            <blockquote>
		                <h4><cite title="Source Title">Type:</h4>
		            </blockquote>
